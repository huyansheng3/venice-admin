...
<template>
  <div class="edit-container" v-loading.fullscreen.lock="fullscreenLoading">
    <el-form :model="Form" ref="ruleForm" label-position="left" class="card-box admin-form">
      ...
      <el-form-item>
        <el-button style="width:100%;" v-loading.fullscreen.lock="fullscreenLoading" type="primary" @click="editGoods">修改</el-button>
      </el-form-item>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      async editGoods() {
        ...
        this.$store.dispatch('EditGoods', FromData).then(res => {
      ...
      async initData() {
        if (!this.$route.params.id) return this.$message.error('商品Id有误');
        this.fullscreenLoading = true;
        this.$store.dispatch('GetProduct', {
          ...
          this.categoryData.defaultCategory.Id = [res.Data.categoryId];
