    ...
    searchCondition() {
      return {
        ...
        startApplyDate: this.searchForm.startApplyDate
          ? moment(this.searchForm.startApplyDate).format('YYYY-MM-DD')
          : undefined,
        endApplyDate: this.searchForm.endApplyDate
          ? moment(this.searchForm.endApplyDate).format('YYYY-MM-DD')
          : undefined,
      }
    },
  },
  ...
  methods: {
    async queryApproveListByCondition() {
      ...
      this.orderList = dataList.map(item => {
        return {
          ...item,
          applyDate: moment(item.parseTime).format('YYYY-MM-DD'),
        }
      })
      this.page = page
    },
